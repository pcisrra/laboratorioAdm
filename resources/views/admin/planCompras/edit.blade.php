...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.planCompra.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.plan-compras.update", [$planCompra->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="categoria">{{ trans('cruds.planCompra.fields.categoria') }}</label>
                <input class="form-control {{ $errors->has('categoria') ? 'is-invalid' : '' }}" type="text" name="categoria" id="categoria" value="{{ old('categoria', $planCompra->categoria) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('c_utili_1') ? 'is-invalid' : '' }}" type="number" name="c_utili_1" id="c_utili_1" value="{{ old('c_utili_1', $planCompra->c_utili_1) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('c_util_2') ? 'is-invalid' : '' }}" type="number" name="c_util_2" id="c_util_2" value="{{ old('c_util_2', $planCompra->c_util_2) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('porcentaje_in') ? 'is-invalid' : '' }}" type="number" name="porcentaje_in" id="porcentaje_in" value="{{ old('porcentaje_in', $planCompra->porcentaje_in) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cant_proyectada') ? 'is-invalid' : '' }}" type="number" name="cant_proyectada" id="cant_proyectada" value="{{ old('cant_proyectada', $planCompra->cant_proyectada) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock_seg') ? 'is-invalid' : '' }}" type="number" name="stock_seg" id="stock_seg" value="{{ old('stock_seg', $planCompra->stock_seg) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cant_compra') ? 'is-invalid' : '' }}" type="number" name="cant_compra" id="cant_compra" value="{{ old('cant_compra', $planCompra->cant_compra) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('costo_total') ? 'is-invalid' : '' }}" type="number" name="costo_total" id="costo_total" value="{{ old('costo_total', $planCompra->costo_total) }}" step="0.01" required>
