    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.beneficiarios.update", [$beneficiario->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_completo') ? 'is-invalid' : '' }}" type="text" name="nombre_completo" id="nombre_completo" value="{{ old('nombre_completo', $beneficiario->nombre_completo) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Beneficiario::GENERO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('genero') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="genero_{{ $key }}" name="genero" value="{{ $key }}" {{ old('genero', $beneficiario->genero) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_ci') ? 'is-invalid' : '' }}" type="number" name="numero_ci" id="numero_ci" value="{{ old('numero_ci', $beneficiario->numero_ci) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('extension_ci') ? 'is-invalid' : '' }}" type="text" name="extension_ci" id="extension_ci" value="{{ old('extension_ci', $beneficiario->extension_ci) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_celular') ? 'is-invalid' : '' }}" type="number" name="num_celular" id="num_celular" value="{{ old('num_celular', $beneficiario->num_celular) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zona_domicilio') ? 'is-invalid' : '' }}" type="text" name="zona_domicilio" id="zona_domicilio" value="{{ old('zona_domicilio', $beneficiario->zona_domicilio) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correo_electronico') ? 'is-invalid' : '' }}" type="text" name="correo_electronico" id="correo_electronico" value="{{ old('correo_electronico', $beneficiario->correo_electronico) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('municipio_vive') ? 'is-invalid' : '' }}" name="municipio_vive" id="municipio_vive" required>
                    ...
                    @foreach(App\Beneficiario::MUNICIPIO_VIVE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('municipio_vive', $beneficiario->municipio_vive) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('macrodistrito_vive') ? 'is-invalid' : '' }}" name="macrodistrito_vive" id="macrodistrito_vive" required>
                    ...
                    @foreach(App\Beneficiario::MACRODISTRITO_VIVE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('macrodistrito_vive', $beneficiario->macrodistrito_vive) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ocupacion') ? 'is-invalid' : '' }}" name="ocupacion" id="ocupacion" required>
                    ...
                    @foreach(App\Beneficiario::OCUPACION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ocupacion', $beneficiario->ocupacion) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo_ingreso') ? 'is-invalid' : '' }}" name="tipo_ingreso" id="tipo_ingreso" required>
                    ...
                    @foreach(App\Beneficiario::TIPO_INGRESO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo_ingreso', $beneficiario->tipo_ingreso) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Beneficiario::ESTUDIO_NIVEL_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('estudio_nivel') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="estudio_nivel_{{ $key }}" name="estudio_nivel" value="{{ $key }}" {{ old('estudio_nivel', $beneficiario->estudio_nivel) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('universidad') ? 'is-invalid' : '' }}" type="text" name="universidad" id="universidad" value="{{ old('universidad', $beneficiario->universidad) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carrera') ? 'is-invalid' : '' }}" type="text" name="carrera" id="carrera" value="{{ old('carrera', $beneficiario->carrera) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('semestre') ? 'is-invalid' : '' }}" type="text" name="semestre" id="semestre" value="{{ old('semestre', $beneficiario->semestre) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('datos_proyecto') ? 'is-invalid' : '' }}" type="text" name="datos_proyecto" id="datos_proyecto" value="{{ old('datos_proyecto', $beneficiario->datos_proyecto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_proyecto') ? 'is-invalid' : '' }}" type="text" name="nombre_proyecto" id="nombre_proyecto" value="{{ old('nombre_proyecto', $beneficiario->nombre_proyecto) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descripcion_proyecto') ? 'is-invalid' : '' }}" name="descripcion_proyecto" id="descripcion_proyecto">{{ old('descripcion_proyecto', $beneficiario->descripcion_proyecto) }}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Beneficiario::RANGO_EMPRENDIMIENTO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('rango_emprendimiento') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="rango_emprendimiento_{{ $key }}" name="rango_emprendimiento" value="{{ $key }}" {{ old('rango_emprendimiento', $beneficiario->rango_emprendimiento) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_emprendimiento') ? 'is-invalid' : '' }}" type="text" name="nombre_emprendimiento" id="nombre_emprendimiento" value="{{ old('nombre_emprendimiento', $beneficiario->nombre_emprendimiento) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Beneficiario::SECTOR_EMPRENDIMIENTO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('sector_emprendimiento') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="sector_emprendimiento_{{ $key }}" name="sector_emprendimiento" value="{{ $key }}" {{ old('sector_emprendimiento', $beneficiario->sector_emprendimiento) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descripcion_emprendimiento') ? 'is-invalid' : '' }}" name="descripcion_emprendimiento" id="descripcion_emprendimiento">{{ old('descripcion_emprendimiento', $beneficiario->descripcion_emprendimiento) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rubro_emprendimiento') ? 'is-invalid' : '' }}" type="text" name="rubro_emprendimiento" id="rubro_emprendimiento" value="{{ old('rubro_emprendimiento', $beneficiario->rubro_emprendimiento) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Beneficiario::MUNICIPIO_EMPRESA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('municipio_empresa') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="municipio_empresa_{{ $key }}" name="municipio_empresa" value="{{ $key }}" {{ old('municipio_empresa', $beneficiario->municipio_empresa) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Beneficiario::MACRODISTRITO_EMPRESA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('macrodistrito_empresa') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="macrodistrito_empresa_{{ $key }}" name="macrodistrito_empresa" value="{{ $key }}" {{ old('macrodistrito_empresa', $beneficiario->macrodistrito_empresa) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direccion_empresa') ? 'is-invalid' : '' }}" type="text" name="direccion_empresa" id="direccion_empresa" value="{{ old('direccion_empresa', $beneficiario->direccion_empresa) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correo_empresa') ? 'is-invalid' : '' }}" type="text" name="correo_empresa" id="correo_empresa" value="{{ old('correo_empresa', $beneficiario->correo_empresa) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('celular_empresa') ? 'is-invalid' : '' }}" type="text" name="celular_empresa" id="celular_empresa" value="{{ old('celular_empresa', $beneficiario->celular_empresa) }}">
