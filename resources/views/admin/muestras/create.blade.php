...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.muestra.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.muestras.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('detalle') ? 'is-invalid' : '' }}" type="text" name="detalle" id="detalle" value="{{ old('detalle', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cantidad') ? 'is-invalid' : '' }}" type="text" name="cantidad" id="cantidad" value="{{ old('cantidad', '') }}">
