            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Fabricacion">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.fabricacion.fields.funcionario_fabricacion') }}
                        </th>
                        <th>
                            {{ trans('cruds.fabricacion.fields.duracion') }}
                        </th>
                        <th>
                            {{ trans('cruds.fabricacion.fields.material_usage') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($fabricacions as $key => $fabricacion)
                        <tr data-entry-id="{{ $fabricacion->id }}">
                            ...
                            <td>
                                @foreach($fabricacion->funcionario_fabricacions as $key => $item)
                            ...
                            <td>
                                {{ $fabricacion->material_usage->codigo ?? '' }}
                            </td>
                            <td>
